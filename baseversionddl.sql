...
CREATE SEQUENCE public.categories_category_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.creators_creator_id_seq;
...
CREATE SEQUENCE public.customer_address_customer_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.customer_address_shipping_id_seq;

CREATE SEQUENCE public.customer_address_shipping_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE public.item_subcategories_category_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.item_subcategories_subcategory_id_seq;

CREATE SEQUENCE public.item_subcategories_subcategory_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.item_variant_item_id_seq;

CREATE SEQUENCE public.item_variant_item_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.item_variant_variant_id_seq;

CREATE SEQUENCE public.item_variant_variant_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE public.items_subcategory_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.pos_cash_drawers_drawer_id_seq;

CREATE SEQUENCE public.pos_cash_drawers_drawer_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE public.pos_cash_transactions_store_employee_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.sales_checkout_checkout_id_seq;

CREATE SEQUENCE public.sales_checkout_checkout_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE public.sales_order_history_status_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.sales_order_line_line_id_seq;
...
CREATE SEQUENCE public.sales_payments_order_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.sales_payments_payment_id_seq;

CREATE SEQUENCE public.sales_payments_payment_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE public.stores_employees_store_employee_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.stores_employees_store_id_seq;

CREATE SEQUENCE public.stores_employees_store_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE public.stores_store_id_seq
	...
	START 1
	CACHE 1
	NO CYCLE;-- public.brands definition
